/*
 g++ ReadResCurrent.cpp QB_lib/cp_communications.cpp QB_lib/qbmove_communications.cpp -std=c++11 -I/usr/include/python2.7 -lpython2.7 -o ReadResCurrent 
*/
...
////////////////////////////////////////// --- control SOFTHAND and read residual current---- /////////////////////////////////////////////////////
	...
	while(elapsed_mseconds_t.count() < 30000) {
		...
		commGetCurrents(&comm_settings_t, SoftHand_id, currents); // Read residual current i.e. Actual hand current - estimated hand current with no load
		residual_current = currents[1];
		printf("Residual current: %hd\t\n ", residual_current);
		fflush(stdout);
		usleep(1000);
