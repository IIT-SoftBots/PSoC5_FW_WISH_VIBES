/*
 g++ Pump_VT_control.cpp QB_lib/cp_communications.cpp QB_lib/qbmove_communications.cpp -std=c++11 -I/usr/include/python2.7 -lpython2.7 -o Pump_VT_control 
*/
...
////////////////////////////////////////////// ---- OPEN RS485 COMMUNICATION ---- /////////////////////////////////////////////////////
	...
	i = 0;
	// 10s drive pump, VT1, V
	start = std::chrono::system_clock::now();
	end = start;
    elapsed_mseconds_t = (end - start) * 1000;
	while(elapsed_mseconds_t.count() < 10000) {

        inputsPULSE[0] = sine[i] * 100; // PUMP input
		inputsPULSE[1] = sine[i] * 20; // VT1 input
        inputsPULSE[2] = sine[i] * 20; // VT2 input 
