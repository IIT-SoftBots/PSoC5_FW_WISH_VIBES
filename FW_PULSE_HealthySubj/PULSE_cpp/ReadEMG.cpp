/*
 g++ ReadEMG.cpp QB_lib/cp_communications.cpp QB_lib/qbmove_communications.cpp -std=c++11 -I/usr/include/python2.7 -lpython2.7 -o ReadEMG
*/
...
//////////////////////////////////////////// ---- Read EMG from sensor ---- //////////////////////////////////////////////
	...
	while(elapsed_mseconds_t.count() < 10000) {
	    commGetEmg(&comm_settings_t, Pulse_id, emg);		           //Read EMG
		printf("Emg 0 : %d\t,Emg 01: %d\t\n,  ", emg[0], emg[1]);
		fflush(stdout);
		usleep(100000);
