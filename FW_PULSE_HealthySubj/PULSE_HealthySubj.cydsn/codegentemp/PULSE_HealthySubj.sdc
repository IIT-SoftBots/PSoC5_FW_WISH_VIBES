...
# Project: C:\Users\mgnocco\Documents\Git\PSoC5\PSoC5_FW_WISH_VIBES\FW_WearableHealtySubj - WISH+Dayton\PULSE_HealthySubj.cydsn\PULSE_HealthySubj.cyprj
# Date: Wed, 27 Nov 2024 12:03:48 GMT
#set_units -time ns
...
create_generated_clock -name {timer_clock} -source [get_pins {ClockBlock/clk_sync}] -edges {1 2 3} [list [get_pins {ClockBlock/dclk_glb_3}]]
create_generated_clock -name {CLOCK_VT} -source [get_pins {ClockBlock/clk_sync}] -edges {1 5 9} [list [get_pins {ClockBlock/dclk_glb_4}]]
...
# Component constraints for C:\Users\mgnocco\Documents\Git\PSoC5\PSoC5_FW_WISH_VIBES\FW_WearableHealtySubj - WISH+Dayton\PULSE_HealthySubj.cydsn\TopDesign\TopDesign.cysch
# Project: C:\Users\mgnocco\Documents\Git\PSoC5\PSoC5_FW_WISH_VIBES\FW_WearableHealtySubj - WISH+Dayton\PULSE_HealthySubj.cydsn\PULSE_HealthySubj.cyprj
# Date: Wed, 27 Nov 2024 12:03:41 GMT
