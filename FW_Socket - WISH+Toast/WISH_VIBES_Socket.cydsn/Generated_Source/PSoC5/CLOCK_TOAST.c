...
/*******************************************************************************
* Function Name: CLOCK_TOAST_Start
********************************************************************************
*
* Summary:
...
void CLOCK_TOAST_Start(void) 
{
    ...
    CLOCK_TOAST_CLKEN |= CLOCK_TOAST_CLKEN_MASK;
	CLOCK_TOAST_CLKSTBY |= CLOCK_TOAST_CLKSTBY_MASK;
}


/*******************************************************************************
* Function Name: CLOCK_TOAST_Stop
********************************************************************************
*
* Summary:
...
void CLOCK_TOAST_Stop(void) 
{
    ...
    CLOCK_TOAST_CLKEN &= (uint8)(~CLOCK_TOAST_CLKEN_MASK);
	CLOCK_TOAST_CLKSTBY &= (uint8)(~CLOCK_TOAST_CLKSTBY_MASK);
}
...
/*******************************************************************************
* Function Name: CLOCK_TOAST_StopBlock
********************************************************************************
*
* Summary:
...
{
    if ((CLOCK_TOAST_CLKEN & CLOCK_TOAST_CLKEN_MASK) != 0u)
    {
        ...
        CLK_DIST_AMASK = CLOCK_TOAST_CLKEN_MASK;
        CLK_DIST_DMASK = 0x00u;
#else
        CLK_DIST_DMASK = CLOCK_TOAST_CLKEN_MASK;
        CLK_DIST_AMASK = 0x00u;
#endif /* CLOCK_TOAST__CFG3 */

        /* Clear mask of bus clock. */
        CLK_DIST_BCFG2 &= (uint8)(~BCFG2_MASK);

        oldDivider = CY_GET_REG16(CLOCK_TOAST_DIV_PTR);
        ...
        CLK_DIST_LD = 0x00u;
        CY_SET_REG16(CLOCK_TOAST_DIV_PTR, oldDivider);
#endif /* HAS_CLKDIST_LD_DISABLE */
    }
}
...
/*******************************************************************************
* Function Name: CLOCK_TOAST_StandbyPower
********************************************************************************
*
* Summary:
...
/*******************************************************************************
* Function Name: CLOCK_TOAST_SetDividerRegister
********************************************************************************
*
* Summary:
                                ...
                                
{
    ...
    uint8 currSrc = CLOCK_TOAST_GetSourceRegister();
    uint16 oldDivider = CLOCK_TOAST_GetDividerRegister();

    if (clkDivider != oldDivider)
    {
        enabled = CLOCK_TOAST_CLKEN & CLOCK_TOAST_CLKEN_MASK;
        ...
        else
        {
            ...
            if (enabled != 0u)
            {
                ...
                if (((CLOCK_TOAST_MOD_SRC & CYCLK_SYNC) == 0u) || (clkDivider == 0u))
                {
#if HAS_CLKDIST_LD_DISABLE
                    CY_SET_REG16(CYREG_CLKDIST_WRK0, oldDivider);
                    CLK_DIST_LD = CYCLK_LD_DISABLE|CYCLK_LD_SYNC_EN|CYCLK_LD_LOAD;
...
/*******************************************************************************
* Function Name: CLOCK_TOAST_GetDividerRegister
********************************************************************************
*
* Summary:
...
{
    return CY_GET_REG16(CLOCK_TOAST_DIV_PTR);
}


/*******************************************************************************
* Function Name: CLOCK_TOAST_SetModeRegister
********************************************************************************
*
* Summary:
...
{
    CLOCK_TOAST_MOD_SRC |= modeBitMask & (uint8)CLOCK_TOAST_MODE_MASK;
}


/*******************************************************************************
* Function Name: CLOCK_TOAST_ClearModeRegister
********************************************************************************
*
* Summary:
...
{
    CLOCK_TOAST_MOD_SRC &= (uint8)(~modeBitMask) | (uint8)(~(uint8)(CLOCK_TOAST_MODE_MASK));
}


/*******************************************************************************
* Function Name: CLOCK_TOAST_GetModeRegister
********************************************************************************
*
* Summary:
...
{
    return CLOCK_TOAST_MOD_SRC & (uint8)(CLOCK_TOAST_MODE_MASK);
}


/*******************************************************************************
* Function Name: CLOCK_TOAST_SetSourceRegister
********************************************************************************
*
* Summary:
...
{
    uint16 currDiv = CLOCK_TOAST_GetDividerRegister();
    uint8 oldSrc = CLOCK_TOAST_GetSourceRegister();
        ...
        (clkSource == ((uint8)CYCLK_SRC_SEL_CLK_SYNC_D))) && (currDiv == 0u))
    {
        ...
        CLOCK_TOAST_MOD_SRC |= CYCLK_SSS;
        CLOCK_TOAST_MOD_SRC =
            (CLOCK_TOAST_MOD_SRC & (uint8)(~CLOCK_TOAST_SRC_SEL_MSK)) | clkSource;
    }
...
/*******************************************************************************
* Function Name: CLOCK_TOAST_GetSourceRegister
********************************************************************************
*
* Summary:
...
{
    return CLOCK_TOAST_MOD_SRC & CLOCK_TOAST_SRC_SEL_MSK;
}
...
/*******************************************************************************
* Function Name: CLOCK_TOAST_SetPhaseRegister
********************************************************************************
*
* Summary:
...
{
    CLOCK_TOAST_PHASE = clkPhase & CLOCK_TOAST_PHASE_MASK;
}


/*******************************************************************************
* Function Name: CLOCK_TOAST_GetPhase
********************************************************************************
*
* Summary:
...
{
    return CLOCK_TOAST_PHASE & CLOCK_TOAST_PHASE_MASK;
}
